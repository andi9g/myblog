...
<div class="col-md-12 ">
  {{-- aksi form  --}}
  <form class="form-horizontal form-label-left" action="{{ route('opsiSlide.update', $tampil->id) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="x_panel">
      <div class="x_title">
        ...
        <br />
          ...
          <div class="form-group row">
            ...
            <div class="col-md-10 col-sm-10 ">
              <input type="file" class="form-control py-1" name="gambar_utama" value="{{ $tampil->gambar }}">
            </div>
          </div>  
          ...
          <div class="form-group row">
            ...
            <div class="col-md-10 col-sm-10 ">
              <textarea name="pesan" id="" cols="20" rows="5" class="form-control @error('pesan')
                  is-invalid
              @enderror" placeholder="pesan">{{ $tampil->pesan }}</textarea>
              @error('pesan')
                <ul class="parsley-errors-list filled" id="parsley-id-5">
                    <li class="parsley-required">
                        {{$message}}
    ...
    <div class="x_panel shadow-sm">
      ...
      <button type="submit" class="btn btn-primary px-5 float-right">
          <i class="fa fa-save"></i> Edit Slide
      </button>
    </div>
