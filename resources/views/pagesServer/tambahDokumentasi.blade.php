...
<div class="col-md-12 ">
  {{-- aksi form  --}}
  <form class="form-horizontal form-label-left" action="{{ route('doc.store') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="x_panel">
      <div class="x_title">
        <h2>Tambah Dokumentasi <small> <i class="">new</i> </small></h2>
        ...
        <br />
          ...
          <div class="form-group row">
            ...
            <div class="col-md-10 col-sm-10 ">
              <input type="file" class="form-control py-1" name="gambar" value="{{old('gambar')}}">
            </div>
          </div>  
    ...
    <div class="x_panel shadow-sm">
      ...
      <button type="submit" class="btn btn-primary px-5 float-right">
          <i class="fa fa-save"></i> Tambah Dokumentasi
      </button>
    </div>
